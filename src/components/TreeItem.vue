<template>
  <li :class="{'item-no-child-box':!model.extend}"  class="item">
    <div >
    ...
    >
      ...
      <!--有括展项-->
            <span v-if="model.extend" class="choose-child">
                <a class="choose-child-add" @click.stop="showchooseChild" v-bind:class="{'color-grey':view.hideChooseChildBtn}">+</a>
...
export default {
  props: ['model', 'parts','menuState','index'],
  components:{
    TreeValueArray
  },
  name:"treeItem",
