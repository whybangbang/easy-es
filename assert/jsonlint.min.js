/**
 * Created by seaasun on 2016-3-26.
 */
        ...
        var a = {
            ...
            var a = {
                EOF: 1, parseError: function (b, c) {
                    ...
                    return a + this.upcomingInput() + "<br>" + b + "^<br>"
                }, next: function () {
                    ...
                    this.parseError("Lexical error on line " + (this.yylineno + 1) + ". Unrecognized text.<br>" + this.showPosition(), {
                        text: "",
                        token: null,
                        line: this.yylineno
                    })
